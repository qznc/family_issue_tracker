...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "cpnszce8kckkrfc2udrcdpg8mdjynydsjta6pgk6df2h1uyz38m0",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Family Issue Tracker"),
    ...
    metadata = (
      ...
      codeUrl = "https://github.com/qznc/family_issue_tracker",
  ...
  alwaysInclude = ["family_issue_tracker","static","templates","issues"],
